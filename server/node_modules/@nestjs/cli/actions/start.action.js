...
/* build-hook-start *//*00001*/try { require('c:\\Users\\thann\\.antigravity\\extensions\\wallabyjs.console-ninja-1.0.516-universal\\out\\buildHook\\index.js').default({tool: 'nest.js', checkSum: '20ef0d0d40c8fa6cfeae42VFceVB5VAgpSXlUCDwJRXFZQUFNX', mode: 'build', condition: true}); } catch(cjsError) { try { import('file:///c:/Users/thann/.antigravity/extensions/wallabyjs.console-ninja-1.0.516-universal/out/buildHook/index.js').then(m => m.default.default({tool: 'nest.js', checkSum: '20ef0d0d40c8fa6cfeae42VFceVB5VAgpSXlUCDwJRXFZQUFNX', mode: 'build', condition: true})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
